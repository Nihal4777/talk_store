										...
										<form action="{{ route('login') }}" method="post">
                                            ...
                                            <div class="section text-center">
                                                ...
                                                <div class="form-group">
                                                    <input type="email" name="email" class="form-style" placeholder="Your Email" id="logemail" value="{{old('email')}}" autocomplete="off" required>
									...
									<div class="center-wrap">
										<form action="{{ route('register') }}" method="post"> 
											...
											<div class="section text-center">
												...
												<div class="form-group">
													<input type="text" name="name" value="{{old('name')}}" class="form-style" placeholder="Your Full Name" id="logname" autocomplete="off">
													<i class="input-icon bi bi-person"></i>
												</div>	
												<div class="form-group mt-2">
													<input type="email" name="email" value="{{old('email')}}" class="form-style" placeholder="Your Email" id="logemail" autocomplete="off">
													<i class="input-icon bi bi-at"></i>
                                                    <x-input-error :messages="$errors->get('email')" class="mt-2 text-white" />
												</div>	
												<div class="form-group mt-2">
